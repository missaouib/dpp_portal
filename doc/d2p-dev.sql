...
CREATE TABLE `d2p`.`sandboxes` (
    ...
    `cloud_instance_uuid` VARCHAR(100) NOT NULL COMMENT 'cloud_instance Table UUID' COLLATE 'utf8mb4_general_ci',
    ...
    `created_at` DATETIME NULL DEFAULT NULL COMMENT '생성날짜',
    `created_user_idx` BIGINT(20) UNSIGNED NOT NULL COMMENT '생성 user PK',
    `updated_at` DATETIME NULL DEFAULT NULL COMMENT '수정날짜',
    `updated_user_idx` BIGINT(20) UNSIGNED NOT NULL COMMENT '수정 user PK',
...
CREATE TABLE `d2p`.`sandbox_images` (
    ...
    `sandbox_image_tags` JSON NULL DEFAULT NULL COMMENT '태그' COLLATE 'utf8mb4_bin',
...
CREATE TABLE `d2p`.`sandbox_models` (
    ...
    `sandbox_model_tags` JSON NOT NULL COMMENT '태그' COLLATE 'utf8mb4_bin',
...
CREATE TABLE `cloud_sandbox_instances` (
    ...
    `ami_id` VARCHAR(100) NOT NULL COMMENT 'Ami ID' COLLATE 'utf8mb4_general_ci',
    `private_ip` VARCHAR(50) NULL DEFAULT NULL COMMENT 'Private IP' COLLATE 'utf8mb4_general_ci',
    `connection_url` VARCHAR(100) NULL DEFAULT NULL COMMENT '접속 URL' COLLATE 'utf8mb4_general_ci',
